...
class TestStudent(unittest.TestCase):
    ...
    def testEnroll(self):
        """Test that enrolling updates both the student record and the course roster SM"""
...
class TestUniversity(unittest.TestCase):
    ...
    def testAddStudent(self):
        ...
        s = self.uni.addStudent("Alice", "STU00001")
    ...
    def testDuplicateStudent(self):
        ...
        s1 = self.uni.addStudent("Alice", "STU00001")
        s2 = self.uni.addStudent("Other", "STU00001")
        self.assertIs(s1, s2)
    ...
    def testInvalidStudentId(self):
        ...
        with self.assertRaises(ValueError):
            self.uni.addStudent("Alice", "BAD001")
    ...
    def testGetStudent(self):
        ...
        self.uni.addStudent("Alice", "STU00001")
    ...
    def testGetCourseEnrollment(self):
        ...
        self.uni.addCourse("CSE2050", 3)
        s1 = self.uni.addStudent("Alice", "STU00001")
        s2 = self.uni.addStudent("Bob",   "STU00002")
